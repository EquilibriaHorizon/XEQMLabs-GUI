...
export class Backend {
   ...
   */
  fetchXEQMPrice() {
    // CoinGecko listing: https://www.coingecko.com/en/coins/xeqm-labs
    // API id: xeqm-labs
    const PRICE_URL =
      "https://api.coingecko.com/api/v3/simple/price?ids=xeqm-labs&vs_currencies=usd";
    fetch(PRICE_URL, {
      method: "GET",
      ...
      .then(data => {
        const price = data?.["xeqm-labs"]?.usd;
        if (
          typeof price !== "number" ||
